...
export abstract class StageBase<
  TInitState extends InitState = InitState,
  TChatState extends ChatState = ChatState,
  TMessageState extends MessageState = MessageState,
  TConfigState extends ConfigState = ConfigState
> {
  ctx: StageContext;
  env: Environment;
